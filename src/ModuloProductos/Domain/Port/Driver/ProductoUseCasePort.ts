...
/**
 * ProductoUseCasePort defines the methods for product-related operations
 * in the use case layer of the application. It provides an abstraction
 * for managing product information and interactions.
 */
